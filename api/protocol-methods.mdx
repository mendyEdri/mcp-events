...
|----------|-------------|-----------|---------|
| Discovery | `initialize` (capability) | Server to Client | Advertise events support |
| Subscribe | `events_subscribe` | Client to Server | Create subscription |
| Manage | `events_unsubscribe` | Client to Server | Remove subscription |
| Manage | `events_list` | Client to Server | List subscriptions |
| Manage | `events_pause` | Client to Server | Pause subscription |
| Manage | `events_resume` | Client to Server | Resume subscription |
| Manage | `events_update` | Client to Server | Modify subscription |
| Deliver | `events/event` | Server to Client | Single event notification |
| Deliver | `events/batch` | Server to Client | Batch event notification |
| Lifecycle | `events/subscription_expired` | Server to Client | Expiration notification |
