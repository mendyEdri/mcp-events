...
- **[Quickstart](/quickstart)** - Get a server and client running in 5 minutes.
- **[Why MCPE?](/why-mcpe)** - Understand the problem MCPE solves and how it compares to webhooks.
- **[Core Concepts](/concepts/protocol)** - Learn about the protocol, events, subscriptions, and transports.
- **[API Reference](/api/server-api)** - Full API docs for EventsServer and EventsClient.
