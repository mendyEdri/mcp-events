...
> **Note:** Whether events that occur during a pause are replayed on resume depends on the server implementation. The reference implementation does not queue events during pause.
